...
class MjmlComponentCarousel extends BaseComponent.BodyComponent {
  ...
  String componentsHeadStyle() {
    ...
    for (int i = 0; i < carouselImagesCount; i++) {
      res.append(".mj-carousel-")
          .append(carouselId)
          .append("-radio:checked ")
          .append("+ * ".repeat(i))
          .append("+ .mj-carousel-content .mj-carousel-image");
    ...
    for (int i = 0; i < carouselImagesCount; i++) {
      res.append(".mj-carousel-")
          ...
          .append(
              ((i - (1 % carouselImagesCount) + carouselImagesCount) % carouselImagesCount) + 1);
    ...
    for (int i = 0; i < carouselImagesCount; i++) {
      res.append(".mj-carousel-")
          ...
          .append(":checked ")
          .append("+ * ".repeat(carouselImagesCount - i - 1))
          .append("+ .mj-carousel-content .mj-carousel-")
          .append(carouselId)
          .append("-thumbnail-")
          .append(i + 1);
      if (i + 1 < carouselImagesCount) {
    ...
    res.append(" {");
    res.append("  border-color: ")
        .append(getAttribute("tb-selected-border-color"))
        .append(" !important;\n");
    res.append("}");
    ...
    res.append("  border-color: ")
        .append(getAttribute("tb-hover-border-color"))
        .append("  !important;\n");
    res.append("}\n");
    ...
    res.append("    .mj-carousel-")
        .append(carouselId)
        .append("-radio-1:checked ")
        .append("+ *".repeat(carouselImagesCount - 1))
        .append("+ .mj-carousel-content .mj-carousel-")
        .append(carouselId)
        .append("-thumbnail-1 {\n");
  ...
  StringBuilder renderMjml(HtmlRenderer renderer) {
    ...
    renderer.openTag(
        ...
        htmlAttributes(
            mapOf(
                "class",
                "mj-carousel-content mj-carousel-" + carouselId + "-content",
                "style",
                "carousel_div")),
        res);
    ...
    return new StringBuilder(msoConditionalTag(res, true))
        .append("\n")
  ...
  private StringBuilder generateControls(String direction, String icon, HtmlRenderer renderer) {
    ...
    renderer.openTag(
        "td",
        htmlAttributes(
            mapOf("class", "mj-carousel-" + carouselId + "-icons-cell", "style", "controls_td")),
        res);
    renderer.openTag(
        "div",
        htmlAttributes(
            mapOf("class", "mj-carousel-" + direction + "-icons", "style", "controls_div")),
        res);
  ...
  private StringBuilder renderFallback(HtmlRenderer renderer) {
    ...
    return new StringBuilder(
        msoConditionalTag(carouselImages.get(0).renderMjml(renderer).toString()));
  }
}
