...
class MjmlComponentNavbar extends BaseComponent.BodyComponent {
  ...
  String headStyle() {
    return "noinput.mj-menu-checkbox { display:block!important; max-height:none!important; visibility:visible!important; }\n"
        ...
        + Utils.makeLowerBreakpoint(context.breakpoint)
        + ") {\n"
  ...
  void setupStyles(CssStyleLibraries cssStyleLibraries) {
    cssStyleLibraries.add("div", mapOf("align", getAttribute("align"), "width", "100%"));
    ...
    cssStyleLibraries.add("icoOpen", mapOf("mso-hide", "all"));
    ...
    res.append(
        msoConditionalTag(
            "<input type=\"checkbox\" id=\""
                + key
                + "\" class=\"mj-menu-checkbox\" style=\"display:none !important; max-height:0; visibility:hidden;\" />\n",
            true));
    res.append("<div ")
        .append(htmlAttributes(mapOf("class", "mj-menu-trigger", "style", "trigger")))
        .append(">\n");
    res.append("<label ")
        .append(
            htmlAttributes(
                mapOf(
                    ...
                    "label",
                    "align",
                    getAttribute("ico-align"))))
        .append(">\n");
    res.append("<span ")
        .append(htmlAttributes(mapOf("class", "mj-menu-icon-open", "style", "icoOpen")))
        .append(">\n");
    res.append(getAttribute("ico-open")).append("\n");
    res.append("</span>\n");
    res.append("<span ")
        .append(htmlAttributes(mapOf("class", "mj-menu-icon-close", "style", "icoClose")))
        .append(">\n");
  ...
  StringBuilder renderMjml(HtmlRenderer renderer) {
    ...
    res.append(
        Utils.equalsIgnoreCase(getAttribute("hamburger"), "hamburger") ? renderHamburger() : "");
    res.append("\n");
    res.append("<div ")
        .append(
            htmlAttributes(
