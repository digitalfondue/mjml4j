...
class MjmlComponentHero extends BaseComponent.BodyComponent {
  ...
  void setupStyles(CssStyleLibraries cssStyleLibraries) {
    ...
    var width =
        getElement().hasAttribute("background-width")
            ? getAttribute("background-width")
            : Utils.doubleToString(getContainerInnerWidth()) + "px";
    ...
    cssStyleLibraries.add("table", mapOf("width", "100%"));

    cssStyleLibraries.add("tr", mapOf("vertical-align", "top"));
    ...
    cssStyleLibraries.add(
        "outlook-table", mapOf("width", doubleToString(getContainerInnerWidth()) + "px"));
    ...
    cssStyleLibraries.add(
        "outlook-inner-table", mapOf("width", doubleToString(getContainerInnerWidth()) + "px"));
                ...
                mapOf(
                    ...
                    "style",
                        inlineCss(
                            mapOf(
                                "background",
                                    bodyComponent.getAttribute("container-background-color"),
                                "font-size", "0px",
  ...
  private StringBuilder renderMode(HtmlRenderer renderer) {
    ...
    if ("fluid-height".equals(getAttribute("mode"))) {
      ...
      renderer.openTag("td", htmlAttributes(mapOf("background", background, "style", "hero")), res);
      ...
      renderer.openTag(
          "td",
          htmlAttributes(
              mapOf("background", background, "style", "hero", "height", doubleToString(height)),
              mapOf("height", doubleToString(height) + "px")),
          res);
      res.append(renderContent(renderer));
      renderer.closeTag("td", res);
    }
  ...
  StringBuilder renderMjml(HtmlRenderer renderer) {
    ...
    res.append("<table ")
        ...
        .append(" >");
    res.append("<tr>");
    res.append("<td ").append(htmlAttributes(mapOf("style", "outlook-td"))).append(">");
    res.append("<v:image ")
        .append(
            htmlAttributes(
                mapOf(
    ...
    renderer.openTag(
        ...
        res);
    renderer.openTag("tbody", res);
    renderer.openTag("tr", htmlAttributes(mapOf("style", "tr")), res);
