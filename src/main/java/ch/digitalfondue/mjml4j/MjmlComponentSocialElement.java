...
class MjmlComponentSocialElement extends BaseComponent.BodyComponent {
  ...
  private static final LinkedHashMap<String, SocialNetworkSettings> DEFAULT_SOCIAL_NETWORKS =
      mapOf(
          entry(
              "facebook",
              new SocialNetworkSettings(
                  "https://www.facebook.com/sharer/sharer.php?u=[[URL]]",
                  "#3b5998",
                  IMAGE_BASE_URL + "facebook.png")),
          entry(
              "twitter",
              new SocialNetworkSettings(
                  "https://twitter.com/intent/tweet?url=[[URL]]",
                  "#55acee",
                  IMAGE_BASE_URL + "twitter.png")),
          entry(
              "x",
              new SocialNetworkSettings(
                  "https://twitter.com/intent/tweet?url=[[URL]]",
                  "#000000",
                  IMAGE_BASE_URL + "twitter-x.png")),
          entry(
              "google",
              new SocialNetworkSettings(
                  "https://plus.google.com/share?url=[[URL]]",
                  "#dc4e41",
                  IMAGE_BASE_URL + "google-plus.png")),
          entry(
              "pinterest",
              new SocialNetworkSettings(
                  "https://pinterest.com/pin/create/button/?url=[[URL]]&media=&description=",
                  "#bd081c",
                  IMAGE_BASE_URL + "pinterest.png")),
          entry(
              "linkedin",
              new SocialNetworkSettings(
                  "https://www.linkedin.com/shareArticle?mini=true&url=[[URL]]&title=&summary=&source=",
                  "#0077b5",
                  IMAGE_BASE_URL + "linkedin.png")),
          entry(
              "instagram",
              new SocialNetworkSettings("", "#3f729b", IMAGE_BASE_URL + "instagram.png")),
          entry("web", new SocialNetworkSettings("", "#4BADE9", IMAGE_BASE_URL + "web.png")),
          entry(
              "snapchat",
              new SocialNetworkSettings("", "#FFFA54", IMAGE_BASE_URL + "snapchat.png")),
          entry(
              "youtube", new SocialNetworkSettings("", "#EB3323", IMAGE_BASE_URL + "youtube.png")),
          entry(
              "tumblr",
              new SocialNetworkSettings(
                  "https://www.tumblr.com/widgets/share/tool?canonicalUrl=[[URL]]",
                  "#344356",
                  IMAGE_BASE_URL + "tumblr.png")),
          ...
          entry(
              "soundcloud",
              new SocialNetworkSettings("", "#EF7F31", IMAGE_BASE_URL + "soundcloud.png")),
          entry(
              "dribbble",
              new SocialNetworkSettings("", "#D95988", IMAGE_BASE_URL + "dribbble.png")),

          // no share
          entry(
              "facebook-noshare",
              new SocialNetworkSettings("[[URL]]", "#3b5998", IMAGE_BASE_URL + "facebook.png")),
          entry(
              "twitter-noshare",
              new SocialNetworkSettings("[[URL]]", "#55acee", IMAGE_BASE_URL + "twitter.png")),
          entry(
              "x-noshare",
              new SocialNetworkSettings("[[URL]]", "#000000", IMAGE_BASE_URL + "twitter-x.png")),
          entry(
              "google-noshare",
              new SocialNetworkSettings("[[URL]]", "#dc4e41", IMAGE_BASE_URL + "google-plus.png")),
          entry(
              "pinterest-noshare",
              new SocialNetworkSettings("[[URL]]", "#bd081c", IMAGE_BASE_URL + "pinterest.png")),
          entry(
              "linkedin-noshare",
              new SocialNetworkSettings("[[URL]]", "#0077b5", IMAGE_BASE_URL + "linkedin.png")),
          entry(
              "instagram-noshare",
              new SocialNetworkSettings("[[URL]]", "#3f729b", IMAGE_BASE_URL + "instagram.png")),
          entry(
              "web-noshare",
              new SocialNetworkSettings("[[URL]]", "#4BADE9", IMAGE_BASE_URL + "web.png")),
          entry(
              "snapchat-noshare",
              new SocialNetworkSettings("[[URL]]", "#FFFA54", IMAGE_BASE_URL + "snapchat.png")),
          entry(
              "youtube-noshare",
              new SocialNetworkSettings("[[URL]]", "#EB3323", IMAGE_BASE_URL + "youtube.png")),
          entry(
              "tumblr-noshare",
              new SocialNetworkSettings("[[URL]]", "#344356", IMAGE_BASE_URL + "tumblr.png")),
          entry(
              "github-noshare",
              new SocialNetworkSettings("[[URL]]", "#000000", IMAGE_BASE_URL + "github.png")),
          entry(
              "xing-noshare",
              new SocialNetworkSettings("[[URL]]", "#296366", IMAGE_BASE_URL + "xing.png")),
          entry(
              "vimeo-noshare",
              new SocialNetworkSettings("[[URL]]", "#53B4E7", IMAGE_BASE_URL + "vimeo.png")),
          entry(
              "medium-noshare",
              new SocialNetworkSettings("[[URL]]", "#000000", IMAGE_BASE_URL + "medium.png")),
          entry(
              "soundcloud-noshare",
              new SocialNetworkSettings("[[URL]]", "#EF7F31", IMAGE_BASE_URL + "soundcloud.png")),
          entry(
              "dribbble-noshare",
              new SocialNetworkSettings("[[URL]]", "#D95988", IMAGE_BASE_URL + "dribbble.png")));
  ...
  void setupStyles(CssStyleLibraries cssStyleLibraries) {
    ...
    cssStyleLibraries.add(
        ...
        mapOf(
            "padding",
            getAttribute("icon-padding"),
            "font-size",
            "0",
            "height",
            !Utils.isNullOrWhiteSpace(socialAttributes.iconHeight)
                ? socialAttributes.iconHeight
                : socialAttributes.iconSize,
            "vertical-align",
            "middle",
            "width",
            socialAttributes.iconSize));
    ...
    cssStyleLibraries.add(
        "img", mapOf("border-radius", getAttribute("border-radius"), "display", "block"));
  ...
  private record SocialAttributes(
      String href,
      String iconSize,
      String iconHeight,
      String srcset,
  ...
  private SocialAttributes getSocialAttributes() {
    ...
    if (socialNetwork != null
        && !Utils.isNullOrEmpty(href)
        && !Utils.isNullOrEmpty(socialNetwork.shareUrl)) {
    ...
    return new SocialAttributes(
        ...
        hasAttribute("src")
            ? getAttribute("src")
            : socialNetwork != null ? socialNetwork.src : null,
        hasAttribute("background-color")
            ? getAttribute("background-color")
            : socialNetwork != null ? socialNetwork.backgroundColor : null);
  }
