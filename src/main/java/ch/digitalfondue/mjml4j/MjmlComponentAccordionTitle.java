...
class MjmlComponentAccordionTitle extends BaseComponent.BodyComponent {
    ...
    void setupStyles(CssStyleLibraries cssStyleLibraries) {
        ...
        cssStyleLibraries.add("td2", mapOf(
                "padding", "16px",
    ...
    private StringBuilder renderIcons(HtmlRenderer renderer) {
        ...
        renderer.openCloseTag("img", htmlAttributes(mapOf(
                "src", getAttribute("icon-wrapped-url"),
                "alt", getAttribute("icon-wrapped-alt"),
                "class", "mj-accordion-more",
                "style", "img"
        )), res);

        renderer.openCloseTag("img", htmlAttributes(mapOf(
                "src", getAttribute("icon-unwrapped-url"),
                "alt", getAttribute("icon-unwrapped-alt"),
